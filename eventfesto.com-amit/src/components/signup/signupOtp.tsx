...
const Index: React.FC<LoginOtpProps> = ({ email, type }) => {
  ...
  return (
    <section className=" flex justify-center items-center w-full h-fit bg-deepskyblue">
      <div className="flex flex-col justify-center items-center bg-white p-2 md:p-6 rounded-lg shadow-md">
        <form onSubmit={handleOtp} className="">
          <div className="text-xl md:text-2xl font-bold mb-2 md:mb-4 text-center">
            OTP
          </div>
          ...
          <div className="text-2xl font-bold mb-2 mt-2 md:mb-4 md:mt-4 text-center">
            Verification Code
          </div>
          <p className="text-gray-500 mt-2 md:mb-4 text-center">
          ...
          <div id="inputs" className="flex justify-center">
            <input
              ...
              className="w-full h-12 text-center outline-none border-b-2 border-gray-300 mr-2"
            />
          </div>
          <button
            type="submit"
            className="w-full mt-8 py-3 px-4 bg-blue-500 text-white rounded-md cursor-pointer"
          >
            Confirm
          </button>
        </form>
